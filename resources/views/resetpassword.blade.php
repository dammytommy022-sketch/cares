...
<head>
    ...
    <title>CryptoGalor | Reset Password</title>
                ...
                <div class="col-12 col-md-6 col-lg-6 col-sm-10 col-xl-6">
                    ...
                    <div class="bg-white shadow card login-page roundedd border-1 ">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{route('postpassword.reset')}}" class=""  method="post" accept-charset="utf-8">
                               @csrf  
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative"> <i data-feather="key" class="fea icon-sm icons"></i>
                                                <input class="pl-5 form-control" type="password" name="password" value="" placeholder="password">
                                            </div>
                                            @error('password')
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative"> <i data-feather="key" class="fea icon-sm icons"></i>
                                                <input class="pl-5 form-control" type="password" name="password_confirmation" value="" placeholder="retype your password here">
                                            </div>
                                        </div>
                                    </div>
                                    <!--end col-->
