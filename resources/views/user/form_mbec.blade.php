...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <h1 class="app-page-title">Mobility And Exercise Chart</h1>
        <div class="row g-4">
            <div class="col-12 col-lg-6">
                <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                    <div class="app-card-header p-3 border-bottom-0">
                        <div class="row align-items-center gx-3">
                            ...
                            <div class="col-auto">
                                ...
                                <small class="mb-0">Log Activity details</small>
                            </div><!--//col-->
                        </div><!--//row-->
                    </div><!--//app-card-header-->
                    <div class="app-card-body px-4 w-100">
                        ...
                        @endif
                        <div class="item  py-3">
                            <form role="form" action="{{ route('hca.postmbec') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    <div class=" mb-3">
                                        <label for="setting-input-6" class="form-label">Activity</label>
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <select name="duration" id="setting-input-6" class="form-control">
                                    ...
                                    <div class="col-6 mb-3">
                                        <label for="setting-input-6" class="form-label">Assistance</label>
                                        <select name="assistance" id="setting-input-6" class="form-control">
                                            <option>-- select activity --</option>
                ...
                <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                    <div class="app-card-header p-3 border-bottom-0">
                        <div class="row align-items-center gx-3">
                            ...
                            <div class="col-auto">
                                <h4 class="app-card-title">Mobility & Exercise History</h4>
                                <small class="mb-0">Activity History</small>
                            </div><!--//col-->
                        </div><!--//row-->
                    </div><!--//app-card-header-->
                    <div class="app-card-body px-4 w-100">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="faq1-{{ $list }}" class="accordion-collapse collapse border-0" aria-labelledby="faq1-heading-{{ $list }}">
                                            <div class="accordion-body text-start p4">
                                                ...
                                                <p>
                                                    Duration: {{ $history->duration }}, Assistance: {{ $history->assistance }} <br>
