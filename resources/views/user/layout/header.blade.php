	        ...
	        <div class="container-fluid py-2">
		        <div class="app-header-content"> 
		            ...
		            <div class="app-utilities col-auto">
			            ...
			            @php
							$user = session('user');
							$userpics = $user->profile_image;
						@endphp
			            
			            <div class="app-utility-item app-user-dropdown dropdown">
							<a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">
								<img src="{{ asset($userpics) }}" class="rounded-circle" alt="user profile">
							</a>
				            <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
								<li><a class="dropdown-item" href="settings.html">Settings</a></li>
								<li><hr class="dropdown-divider"></li>
								<li>
									<a class="dropdown-item" href="{{route('hca.logout')}}" 
			    ...
			    <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
				    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
					    <li class="nav-item">
					        ...
					        <a class="nav-link active" href="{{route('hca.index')}}">
						        <span class="nav-icon">
					    ...
					    <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{route('hca.settings')}}">
                                <span class="nav-icon">
