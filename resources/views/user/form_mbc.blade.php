...
@section('content')
  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
      <h1 class="app-page-title">Mood And Behaviour Chart</h1>
      <div class="row g-4">
          ...
          <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
            <div class="app-card-header p-3 border-bottom-0">
              <div class="row align-items-center gx-3">
                ...
                <div class="col-auto">
                  <h4 class="app-card-title">+Add New Mood Record</h4>
                  <small class="mb-0">Record Mood details</small>
                </div><!--//col-->
              </div><!--//row-->
            </div><!--//app-card-header-->
            <div class="app-card-body px-4 w-100">
              ...
              <?php endif; ?>
              <div class="item  py-3">
                <form role="form" action="{{ route('hca.postmbc') }}" method="POST">
                  @csrf
                  ...
                  <div class="mb-3">
                    <textarea name="mood_details" id="mood" placeholder="Record mood..." class="form-control" cols="60"
                      rows="10"></textarea>
                  </div>
                  <div class="mb-3">
