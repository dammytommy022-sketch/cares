...
@section('content')
  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
      <h1 class="app-page-title">Fluids Chart</h1>
      <div class="row g-4">
          ...
          <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
            <div class="app-card-header p-3 border-bottom-0">
              <div class="row align-items-center gx-3">
                ...
                <div class="col-auto">
                  <h4 class="app-card-title">+Add New Fluid Record</h4>
                  <small class="mb-0">Record Fluids details</small>
                </div><!--//col-->
              </div><!--//row-->
            </div><!--//app-card-header-->
            <div class="app-card-body px-4 w-100">
              ...
              @endif
              <div class="item  py-3">
                <form role="form" action="{{ route('hca.postfc') }}" method="POST">
                  @csrf
                  ...
                  <div class="row">
                    <div class="col-6 mb-3">
                      <label for="setting-input-6" class="form-label">Ml</label>
                    ...
                    <h6>Drink times</h6>
                    <div class="col-6 mb-3">
                      <label for="setting-input-6" class="form-label">Date</label>
                  ...
                  <div class="mb-3">
                    <textarea name="info" id="info" placeholder="Additional Information..." class="form-control" cols="60"
                      rows="10"></textarea>
                  </div>
                  <h6>Daily Total</h6>
                  <p></p>
                        ...
                        <div class="accordion-item">
                          ...
                          <h2 class="accordion-header" id="faq1-heading-{{ $list }}">
                            <button class="accordion-button btn btn-link" type="button" data-bs-toggle="collapse"
                              data-bs-target="#faq1-{{ $list }}" aria-expanded="false"
                              aria-controls="faq1-{{ $list }}">
                              {{ $history->date_log }}- <small><i> ({{ $history->time_log }})</i></small>
                            </button>
                          </h2>
                          <div id="faq1-{{ $list }}" class="accordion-collapse collapse border-0"
                            aria-labelledby="faq1-heading-{{ $list }}">
                            <div class="accordion-body text-start p4">

                              <p> {{ $history->type }} | {{ $history->amount }}</p>
                              <small>{{ $history->info }}</small>
                              <div class="text-end">
