...
@section('content')
  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
      <h1 class="app-page-title">Bowel Movement Chart</h1>
      <div class="row g-4">
          ...
          <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
            <div class="app-card-header p-3 border-bottom-0">
              <div class="row align-items-center gx-3">
                ...
                <div class="col-auto">
                  <h4 class="app-card-title">+Add New Bowel Record</h4>
                  <small class="mb-0">Bowel Movement Chart</small>
                </div><!--//col-->
              </div><!--//row-->
            </div><!--//app-card-header-->
            <div class="app-card-body px-4 w-100">
              ...
              @endif
              <div class="item  py-3">
                <form role="form" action="{{ route('hca.postbc') }}" method="POST">
                  @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="col-6 mb-3">
                      <label for="setting-input-6" class="form-label">Type</label>
                        ...
                        <div class="accordion-item">
                          ...
                          <h2 class="accordion-header" id="faq1-heading-{{ $list }}">
                            <button class="accordion-button btn btn-link" type="button" data-bs-toggle="collapse"
                              ...
                              {{ $history->type }}- <small><i> ({{ $history->time_log }})</i></small>
                            </button>
                          </h2>
