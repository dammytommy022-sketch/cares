...
@section('content')
  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
      <h1 class="app-page-title">Food Intake Chart</h1>
      <div class="row g-4">
          ...
          <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
            <div class="app-card-header p-3 border-bottom-0">
              <div class="row align-items-center gx-3">
                ...
                <div class="col-auto">
                  <h4 class="app-card-title">+Add New Food Intake Record</h4>
                  <small class="mb-0">Food Intake Chart</small>
                </div><!--//col-->
              </div><!--//row-->
            </div><!--//app-card-header-->
            <div class="app-card-body px-4 w-100">
              ...
              @endif
              <div class="item  py-3">
                <form role="form" action="{{ route('hca.postfic') }}" method="POST">
                  @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="col-6 mb-3">
                      ...
                      <select name="meal_type" id="type" class="form-select">
                        ...
                        <div class="accordion-item">
                          ...
                          <h2 class="accordion-header" id="faq1-heading-{{ $list }}">
                            <button class="accordion-button btn btn-link" type="button" data-bs-toggle="collapse"
                              ...
                              {{ $history->meal_type }}-{{ $history->meal_portion }}- <small><i>
                                  ({{ $history->time_log }})</i></small>
                            </button>
                          </h2>
