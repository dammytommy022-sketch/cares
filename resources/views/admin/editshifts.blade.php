                                    ...
                                    <div class="app-card-body">
                                        <div class="col-md-12 ">
                                            <div class="card card-plain"> 
                                                ...
                                                <h6 class="section-title">Edit Shedule</h6>
                                                <small class="mb-5">Edit Shift Schedule</small>
                                                @if (session('error'))
                                                ...
                                                <div class="card-body bg-white">
                                                    ...
                                                    @enderror
                                                    <form role="form" class="settings-form" action="{{ route('admin.updateshift', ['id' => $shifts->id]) }}" method="POST">
                                                        @csrf
                                                        {{-- First stage --}}
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col ">
                                                                ...
                                                                @error('nurse2')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                                <input type="hidden" name="nursefloor2" id="floor" class="form-control" value="{{$shifts->nursefloor2}}"  />
                                                            </div>
                                                            <br>
                                                        </div>
                                                        {{-- second stage --}}
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col ">
                                                                ...
                                                                @error('nurse3')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                                <input type="hidden" name="nursefloor3" id="floor" class="form-control" value="{{$shifts->nursefloor3}}"  />
                                                        ...
                                                        <div class="col-4">
                                                            <div class="text-center">
                                                                <button type="submit" class="btn bg-primary text-white  w-50 mt-4 mb-0">Update Schedule</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
