      ...
      <div class="col-xl-5">
        ...
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            <img src="{{ asset($admin) }}" alt="Profile" class="rounded-circle" style="height: 200px; width: 200px;">
            <h5>{{$adminP->fullname}}</h5>
            <h6>{{$adminP->username}}</h6>
            <div class="col-12 text-start">
              <h6 class="card-title">Profile Details</h6>
              <div class="row mb-3">
                <div class="col-lg-4  label">Full Name</div>
                <div class="col-lg-8">{{$adminP->fullname}}</div>
              </div>

              <div class="row mb-3">
                <div class="col-lg-4  label">Position</div>
                <div class="col-lg-8">{{$adminP->username}}</div>
              </div>

              <div class="row mb-3">
                <div class="col-lg-4  label">Email</div>
                <div class="col-lg-8">{{$adminP->email}}</div>
              </div>
            </div>
          </div>
        </div>
                ...
                <form id="profileForm" method="POST" action="{{ route('update-profile') }}"
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <img id="profileImg" src="{{ asset($admin) }}" class="rounded-circle" style="height: 100px; width: 100px;" alt="Profile">
                      <div class="pt-2">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input type="text" class="form-control" id="fullName" name="fullName" value="{{$adminP->fullname}}">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input type="text" class="form-control" id="Job"  value="{{$adminP->username}}">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input type="email" class="form-control" id="email" value="{{$adminP->email}}">
                    </div>
                  </div>
