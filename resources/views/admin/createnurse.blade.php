            ...
            <div class="app-card-body  px-4">
                <div >
                    ...
                    <div class="card card-plain">
                        ...
                        <small class="mb-5">Create New Nurse Account</small>
                        <div class="card-body bg-white">
                        <form role="form" class="settings-form" action="{{ route('admin.postcreatenurse')}}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class=" mb-3">
                                ...
                                <div class="col-sm-4">
                                    <div class=" mb-3">
                                        <label for="setting-input-20" class="form-label">Position / Qulification</label>
                                        <input type="text" name="position" class="form-control" id="setting-input-20" placeholder="position/qulification" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class=" mb-3">
                                        <label for="setting-input-18" class="form-label">Supervision </label>
                                        <input type="text" name="supervision" class="form-control" id="setting-input-16" placeholder="supervision" required>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class=" mb-3">
                                        <label for="setting-input-19" class="form-label">DBS Status</label>
                                        <input type="text" name="status" class="form-control" id="setting-input-19" placeholder="DBS status" required>
                                    </div>
                                </div>
