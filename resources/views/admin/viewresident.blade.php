                            ...
                            <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                                ...
                                <div class="app-card-body px-4 w-100">
                                    ...
                                    <div class="item border-bottom py-2">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <div class="item-data">{{ $residents->title}}</div>
                                            </div><!--//col-->
                                    ...
                                    <div class="item border-bottom py-2">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <div class="item-data">{{ $residents->fullname}}</div>
                                            </div><!--//col-->
                                    ...
                                    <div class="item border-bottom py-2">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                <div class="item-label"><strong>D.O.B</strong></div>
                                                <div class="item-data">{{ $residents->dob}}</div>
                                            </div><!--//col-->
                                    ...
                                    <div class="item border-bottom py-2">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <div class="item-data">{{ $residents->email}}</div>
                                            </div><!--//col-->
                                    ...
                                    <div class="item border-bottom py-2">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                <div class="item-label"><strong>Nationalty</strong></div>
                                                <div class="item-data">
                                                {{ $residents->nationalty}}
                                                </div>
                                            </div><!--//col-->
                                        </div><!--//row-->
                                    </div><!--//item-->
                            ...
                            <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                                ...
                                <div class="app-card-body px-4 w-100">
                                    <div class="item border-bottom py-3">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                <div class="item-label"><strong>Room No.</strong></div>
                                                <div class="item-data">{{$residents->room_no}}</div>
                                            </div><!--//col-->
                                            <div class="col text-end">
                                                @if($residents->status == "active")
										            <button class="btn-sm app-btn-primary"> Active </button>
                                                @elseif($residents->status == "disabled")
                                    ...
                                    <div class="item border-bottom py-3">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <div class="item-data">{{$residents->next_of_kin}}</div>
                                            </div><!--//col-->
                                    ...
                                    <div class="item border-bottom py-3">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                <div class="item-label"><strong>Relationship</strong></div>
                                                <div class="item-data">{{$residents->relationship}}</div>
                                            </div><!--//col-->
                                    ...
                                    <div class="item border-bottom py-3">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <div class="item-data">{{$residents->phone_no}}</div>
                                            </div><!--//col-->
                                    ...
                                    <div class="item border-bottom py-3">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                <div class="item-label"><strong>Address</strong></div>
                                                <div class="item-data">{{$residents->nextofkin_address}}</div>
                                            </div><!--//col-->
                                    ...
                                    <div class="item border-bottom py-3">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                <div class="item-label"><strong>Gender</strong></div>
                                                <div class="item-data">{{$residents->nextofkin_gender}}</div>
                                            </div><!--//col-->
                                ...
                                <div class="app-card-footer p-4 mt-auto">
                                    <a class="btn app-btn-secondary" href="{{ route('admin.editresidents', $residents->id) }}">Edith Account</a>
                                </div><!--//app-card-footer-->
